...
jwcompo = {
	commonnav :()=>{
		...
		my_navbar : ()=>{
			...
			+'    <li><div id="mypage" style="top:11px; left:10px; margin-right: 70px; margin-left: 35px;">'
			+' <img class="img-circle" alt="Cinque Terre" src="resources/img/aquagram/test_img.jpg" style="width: 50px; height: 50px; position: center;"/>mpick04</div></li>'
