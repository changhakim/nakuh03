	        ...
	        +'<div class="content">'
	            +'<div class="container-fluid">'
	                +'<div class="row" style="margin-bottom: 50px;">'
	                    +'<div class="col-md-4">'
	                        +'<div class="card">'
	                            ...
	                            +'</div>'
	                            +'<div class="content contentcount" id="today"style="height: 125px;">'
	                            +'</div>'
	                        +'</div>'
	                    +'</div>'
	                    +'<div class="col-md-4">'
                        +'<div class="card">'
                            ...
                            +'</div>'
                            +'<div class="content contentcount" id="total" style="height: 125px;">'
                            +'</div>'
                        +'</div>'
                    +'</div>'
                    +'<div class="col-md-4">'
                    +'<div class="card">'
                        ...
                        +'</div>'
                        +'<div class="content contentcount" style="height: 125px;">'                           
                        +'</div>'
                    +'</div>'
                +'</div>'                    
	                +'</div>'
	                +'<div class="row">'
	                    +'<div class="col-md-12">'
	                        +'<div class="card ">'
	                            ...
	                            +'</div>'
	                            +'<div id="lineChartArea" style="padding:0px 0px 0px 0px;"></div>'
